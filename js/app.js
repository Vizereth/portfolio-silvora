 ...
 */                    !function(o, s) {
                            ...
                            return function(t, e) {
                                ...
                                function s(t, e, a) {
                                    ...
                                    "string" == typeof t && (u = document.querySelectorAll(t)), u ? (this.elements = function(t) {
                                        ...
                                        return [ t ];
                                    }(u), this.options = i({}, this.options), "function" == typeof e ? a = e : i(this.options, e), 
                                    a && this.on("always", a), this.getImages(), n && (this.jqDeferred = new n.Deferred), 
                    ...
                    t.exports = function(t, e) {
                        var n = e && e.cache ? e.cache : u, r = e && e.serializer ? e.serializer : s;
                    ...
                    var r = {
                        ...
                        VERTICAL: "vertical"
                    }, o = /(^linear$)|(^ease-in-out$)|(^ease-in$)|(^ease-out$)|(^ease$)|(^step-start$)|(^step-end$)|(^steps\(\d\s*,\s*(end|start)\))$|(^cubic-bezier\((\d*\.*\d+)\s*,\s*(\d*\.*\d+)\s*,\s*(\d*\.*\d+)\s*,\s*(\d*\.*\d+)\))$/, s = function(t, e, n, r, i) {
                        if (void 0 !== e) {
                            var o = new Error('Filterizr: expected type of option "' + t + '" to be "' + n + '", but its type is: "' + typeof e + '"'), s = !1, a = !1, u = n.includes("array");
                            ...
                            } else if ("string" == typeof e && r instanceof RegExp) if (!e.match(r)) throw new Error('Filterizr: invalid value "' + e + '" for option "' + t + '" received.' + c(i));
                        }
                    }, a = function(t, e, n) {
                        var r;
                        return function() {
                        ...
                        return t.length === e.length && t.reduce((function(t, n, r) {
                            var i = n.getSortAttribute("index"), o = e[r].getSortAttribute("index");
                            return t && i === o;
                        }), !0);
                    };
                    var c = function(t) {
                    ...
                    function f(t) {
                        ...
                        var o = r.shift();
                        if (l(t) && l(o)) for (var s in o) l(o[s]) ? (t[s] || Object.assign(t, ((e = {})[s] = {}, 
                        e)), f(t[s], o[s])) : Object.assign(t, ((n = {})[s] = o[s], n));
                    ...
                    var d = function(t) {
                        ...
                        return t.prototype.on = function(t, e) {
                            var n = this.receiver, r = n instanceof NodeList;
                            !!this.eventDictionary[t] && delete this.eventDictionary[t], r && n.length ? (this.eventDictionary[t] = e, 
                            Array.from(n).forEach((function(n) {
                                n.addEventListener(t, e);
                            }))) : !r && n && (this.eventDictionary[t] = e, n.addEventListener(t, e));
                        }, t.prototype.off = function(t) {
                            var e = this.receiver, n = this.eventDictionary[t], r = e instanceof NodeList;
                            r && e.length ? Array.from(e).forEach((function(e) {
                                e.removeEventListener(t, n);
                            })) : !r && e && e.removeEventListener(t, n), delete this.eventDictionary[t];
                        }, t.prototype.destroy = function() {
                            var t = this, e = this.receiver, n = e instanceof NodeList;
                        ...
                        return Object.defineProperty(t.prototype, "isSpinnerEnabled", {
                            ...
                            return s("animationDuration", t.animationDuration, "number"), s("callbacks", t.callbacks, "object"), 
                            s("controlsSelector", t.controlsSelector, "string"), s("delay", t.delay, "number"), 
                            s("easing", t.easing, "string", o, "https://www.w3schools.com/cssref/css3_pr_transition-timing-function.asp"), 
                            s("delayMode", t.delayMode, "string", [ "progressive", "alternate" ]), s("filter", t.filter, "string|number|array"), 
                            s("filterOutCss", t.filterOutCss, "object"), s("filterInCss", t.filterOutCss, "object"), 
                            s("gridItemsSelector", t.gridItemsSelector, "string"), s("gutterPixels", t.gutterPixels, "number"), 
                            s("layout", t.layout, "string", Object.values(i)), s("multifilterLogicalOperator", t.multifilterLogicalOperator, "string", [ "and", "or" ]), 
                            s("searchTerm", t.searchTerm, "string"), s("setupControls", t.setupControls, "boolean"), 
                            t;
                        }, t;
                    }(), w = function() {
                        function t(t, e) {
                            void 0 === e && (e = ""), this.filterizr = t, this.selector = e, this.filterControls = new y(document.querySelectorAll(e + "[data-filter]")), 
                            this.multiFilterControls = new y(document.querySelectorAll(e + "[data-multifilter]")), 
                            this.shuffleControls = new y(document.querySelectorAll(e + "[data-shuffle]")), this.searchControls = new y(document.querySelectorAll(e + "[data-search]")), 
                            this.sortAscControls = new y(document.querySelectorAll(e + "[data-sortAsc]")), this.sortDescControls = new y(document.querySelectorAll(e + "[data-sortDesc]")), 
                            this.initialize();
                        }
                        return t.prototype.destroy = function() {
                            this.filterControls.destroy(), this.multiFilterControls.destroy(), this.shuffleControls.destroy(), 
                            this.searchControls.destroy(), this.sortAscControls.destroy(), this.sortDescControls.destroy();
                    ...
                    var S, O = function(t, e, n, r) {
                        ...
                        return T(e, t), e.prototype.initialize = function() {
                            ...
                            var t = this.options.get().gutterPixels, e = this.node.parentElement.clientWidth, n = this.node.clientWidth, r = n - t * (1 / Math.floor(e / n) + 1) + "px";
                            this.set({
                                width: r
                            });
                        ...
                        function e(e, n, r) {
                            ...
                            return i.filteredOut = !1, i.lastPosition = {
                                ...
                                for (var e = {
                                    ...
                                    var o = r[n], s = o.nodeName, a = o.nodeValue;
                        ...
                        return z(e, t), Object.defineProperty(e.prototype, "styles", {
                            ...
                            this.eventReceiver.on("transitionend", (function() {
                                t.filteredOut ? (t.node.classList.add("filteredOut"), t.styles.setZIndex(-1e3), 
                                t.styles.setHidden()) : (t.node.classList.remove("filteredOut"), t.styles.removeZIndex());
                            }));
                        ...
                        return Object.defineProperty(t.prototype, "styles", {
                            ...
                            var e = this, n = this.options.searchTerm, r = this.search(this.filterItems, n);
                            return "all" === t ? r : r.filter((function(n) {
                                return e.shouldBeFiltered(n.getCategories(), t);
                            }));
                        }, t.prototype.getFilteredOut = function(t) {
                            var e = this, n = this.options.searchTerm;
                            return this.filterItems.filter((function(r) {
                                var i = r.getCategories(), o = e.shouldBeFiltered(i, t), s = r.contentsMatchSearch(n);
                                return !o || !s;
                            }));
                        ...
                        function e(e, n) {
                            ...
                            return (i = t.call(this, e, n) || this).styledNode = new Q(e, n), i._filterizrState = r.IDLE, 
                            i.styles.initialize(), i.filterItems = i.makeFilterItems(i.options), i.bindEvents(), 
                            i;
                        }
                        return V(e, t), Object.defineProperty(e.prototype, "styles", {
                            get: function() {
                                return this.styledNode;
                            },
                            enumerable: !0,
                            ...
                            var t = this, e = this.options.get(), n = e.animationDuration, i = e.callbacks, o = e.delay, s = e.delayMode, u = e.gridItemsSelector, c = "progressive" === s ? o * this.filterItems.length : o;
                            ...
                            }), 100 * n + c, !1)), this.eventReceiver.on("init", i.onInit), this.eventReceiver.on("filteringStart", i.onFilteringStart), 
                            this.eventReceiver.on("filteringEnd", i.onFilteringEnd), this.eventReceiver.on("shufflingStart", i.onShufflingStart), 
                            this.eventReceiver.on("shufflingEnd", i.onShufflingEnd), this.eventReceiver.on("sortingStart", i.onSortingStart), 
                            this.eventReceiver.on("sortingEnd", i.onSortingEnd);
                        }, e.prototype.unbindEvents = function() {
                            this.eventReceiver.off("transitionend"), this.eventReceiver.off("init"), this.eventReceiver.off("filteringStart"), 
                            this.eventReceiver.off("filteringEnd"), this.eventReceiver.off("shufflingStart"), 
                            this.eventReceiver.off("shufflingEnd"), this.eventReceiver.off("sortingStart"), 
                    ...
                    var U = function() {
                        ...
                        function t(t, e) {
                            ...
                            (i = document.createElement("img")).classList.add("Filterizr__spinner"), i.src = "data:image/svg+xml;base64," + window.btoa(r), 
                            i.alt = "Spinner", i), this.styledNode = new tt(this.node, e), this.initialize();
                        }
                        return Object.defineProperty(t.prototype, "styles", {
                            get: function() {
                                return this.styledNode;
                    ...
                    var ut = function() {
                        ...
                        var r = n.gutterPixels, o = n.layout;
                        if (!e.length) return {
                            containerHeight: 0,
                            itemsPositions: []
                        };
                        switch (o) {
                          ...
                          case i.SAME_HEIGHT:
                            return function(t, e, n) {
                                var r = e.map((function(t, r) {
                                    ...
                                    var a = o.height, u = Math.floor(r[s] / t);
                                    return {
                          ...
                          case i.SAME_WIDTH:
                            return function(t, e, n) {
                                var r = Math.floor(t / (e[0].width + n)), i = e.map((function(t, i) {
                                    var o = t.width, s = Math.floor(i / r);
                                    return {
                                        left: (i - r * s) * (o + n),
                                    ...
                                    var o = e.height, s = Math.floor(i / r);
                          ...
                          case i.PACKED:
                            return function(t, e, n) {
                                var r = new ct(t), i = e.map((function(t) {
                          ...
                          default:
                            return function(t, e, n) {
                                var r = Math.floor(t / (e[0].width + n)), i = e.map((function(t, e) {
                                    var i = t.width, o = t.height, s = Math.floor(e / r);
                                    return {
                                        left: (e - r * s) * (i + n),
                                        top: s * (o + n)
                                    };
                    ...
                    function ft(t) {
                        ...
                        t.fn.filterizr = function() {
                            var e = "." + t.trim(this.get(0).className).replace(/\s+/g, "."), n = arguments;
                            if (!this._fltr && 0 === n.length || 1 === n.length && "object" == typeof n[0]) {
                                ...
                                var i = n[0], o = Array.prototype.slice.call(n, 1), s = this._fltr;
                                switch (i) {
                                  case "filter":
                    ...
                    var ht = function(t, e, n, r) {
                        ...
                        function t(t, e) {
                            ...
                            var n = this.options, r = n.areControlsEnabled, i = n.controlsSelector, o = n.isSpinnerEnabled;
                            this.windowEventReceiver = new y(window), this.filterContainer = new J(c(t), this.options), 
                            this.imagesHaveLoaded = !this.filterContainer.node.querySelectorAll("img").length, 
                            r && (this.filterControls = new w(this, i)), o && (this.spinner = new rt(this.filterContainer, this.options)), 
                            this.initialize();
                        }
                        return Object.defineProperty(t.prototype, "filterItems", {
                            ...
                            void 0 === t && (t = "index"), void 0 === e && (e = "asc");
                            var n = this.filterContainer, i = this.filterItems;
                            n.trigger("sortingStart"), n.filterizrState = r.SORTING, i.sort(t, e), this.render();
                        }, t.prototype.search = function(t) {
                            void 0 === t && (t = this.options.get().searchTerm), this.options.searchTerm = t.toLowerCase(), 
                            this.render();
                        }, t.prototype.shuffle = function() {
                            ...
                            var e = this.filterContainer, n = this.filterItems, r = "animationDuration" in t || "delay" in t || "delayMode" in t;
                            (t.callbacks || r) && e.unbindEvents(), this.options.set(t), (t.easing || r) && n.styles.updateTransitionStyle(), 
                            (t.callbacks || r) && e.bindEvents(), "searchTerm" in t && this.search(t.searchTerm), 
                            ("filter" in t || "multifilterLomultifilterLogicalOperator" in t) && this.filter(this.options.filter), 
                            "gutterPixels" in t && (this.filterContainer.styles.updatePaddings(), this.filterItems.styles.updateWidthWithTransitionsDisabled(), 
                            this.render());
                        }, t.prototype.toggleFilter = function(t) {
                            this.options.toggleFilter(t), this.filter(this.options.filter);
                        }, t.prototype.render = function() {
                            var t = this.filterContainer, e = this.filterItems, n = this.options, r = e.getFiltered(n.filter);
                            e.styles.resetDisplay(), e.getFilteredOut(n.filter).forEach((function(t) {
                                t.filterOut();
                            }));
                            var i = lt(t.dimensions.width, r.map((function(t) {
                                return t.dimensions;
                            })), this.options.get()), o = i.containerHeight, s = i.itemsPositions;
                            ...
                            return ht(this, void 0, void 0, (function() {
                                ...
                                return pt(this, (function(i) {
                                    switch (i.label) {
                                      case 0:
                                        return e = (t = this).filterContainer, n = t.filterItems, r = t.spinner, this.bindEvents(), 
                        ...
                        }, t.FilterContainer = J, t.FilterItem = N, t.defaultOptions = v, t.installAsJQueryPlugin = ft, 
                        t;
                    }();
    ...
    (() => {
        ...
        var filterizr_min = __webpack_require__(517);
        const initFilterizr = () => {
            const initFilterButtons = () => {
                ...
                filterButtons.forEach((btn => {
                    btn.addEventListener("click", (e => {
                        e.stopPropagation();
                        const prevActiveButton = filterList.querySelector(".portfolio__filter-btn--active");
            ...
            const portfolioItemsContainer = portfolioSection.querySelector(".portfolio__items");
            const options = {};
            new filterizr_min(portfolioItemsContainer, options);
            initFilterButtons();
        };
        const portfolio = initFilterizr;
        const countTextareaCharacters = () => {
            const contactForm = document.querySelector(".contact__form");
            if (!contactForm) return;
            const textarea = contactForm.querySelector("textarea");
            const currentCountElement = contactForm.querySelector(".contact__textarea-count-current");
